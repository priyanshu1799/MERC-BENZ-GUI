...
for dpay =20:100
    mon=mn;
 for i=1:term
   string= (get(handles.downpay,'String'));
      outstanding= emi1*(term-mon);
   totalcost= outstanding+ str2num(handles.datasort1{get(handles.topmodels,'Value'),handles.a});
   cost_aftr_dpay = (1-(dpay/100))*totalcost;
